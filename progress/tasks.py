...
def ProcessDownload(self, url):
	...
	print('TASKDownload: Task started')
	...
	try:
		...
		print(f'TASKSubprocess terminated [Code {download.returncode}]')
	except subprocess.TimeoutExpired:
		# Process was not terminated in the timeout period
		print('TASKSubprocess did not terminate on time')
	...
	if download.returncode == 0:
		...
		try:
			...
			print('TASKCould not delete file')
